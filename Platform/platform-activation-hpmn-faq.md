# Decision around how to activate Platform and Evolution Nodes FAQ
...
* The second is one of multiple solutions in a category called “Evolution Nodes”.
...
* The 4K Evolution Node Solution
* The 10K Evolution Node Solution
...
* 3.8M Dash locked in either Masternodes or Evolution Nodes
* 45$ Dash price
...
Lower user fees is an attractive advantage of the Evolution Node solutions, however DCG would still be in favor of these solutions even if fees were not a factor. The reasons for this become apparent later in this FAQ.
...
As far as registration goes, setting up an Evolution Node would be very similar to setting up a normal masternode, except for the higher collateral.
